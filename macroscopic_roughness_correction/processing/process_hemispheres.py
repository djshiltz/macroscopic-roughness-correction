...
for mineral in ['olivine', 'quartz']:
    ...
    collect = np.load(f'{ROOT_DIR}/macroscopic_roughness_correction/data/{mineral}/rough_hemisphere_measurements.npy',
    ...
    np.save(f'{ROOT_DIR}/macroscopic_roughness_correction/data/{mineral}/processed_data/rough_hemisphere_processed.npy', collect_processed, allow_pickle=True)
